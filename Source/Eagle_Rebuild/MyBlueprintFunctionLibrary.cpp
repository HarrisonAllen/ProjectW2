...
#include "Eagle_Rebuild.h"
#include "MyBlueprintFunctionLibrary.h"

#include <cstdlib>

void UMyBlueprintFunctionLibrary::set_rotation_at_spline_point(USplineComponent* target, const int32 point_index, const FRotator rotation) //exactly the same as in .h but without 'static' and with Uspline_extensions:: in front of the function name
{
